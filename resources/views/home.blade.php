...
<main>
    ...
    <section class="py-5 text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Commandez  votre <br><span class="badge badge-pill badge-primary">nouveau</span> <br>T-Shirt <span class="badge badge-pill badge-primary"> préféré </span>!</h1>
