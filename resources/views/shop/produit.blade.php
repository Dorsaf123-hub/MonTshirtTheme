        ...
        <div class="row justify-content-between">
            ...
            <div class="col-6">
                ...
                <span class="badge badge-info">
                    <a class="text-white" href="{{ route('voir_produits_par_tag',['id'=> $tag->id])}}">{{$tag->nom}}</a></span>
                @endforeach
...
<div class="album py-5 bg-light">
    <div class="container">
        ...
        <div class="row">
            @foreach($produit->recommandations as $produit->recommande)
            <div class="col-md-4">
                <div class="card mb-4 box-shadow">
                    <img src="{{ asset('produits/'.$produit->recommande->photo_principale)}}" class="card-img-top img-fluid" alt="Responsive image">

                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <div class="btn-group">
                                <a href="{{ route('voir_produit',['id'=>$produit->recommande->id])}}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
